...
TELEGRAM_CONNECT_TIMEOUT = env_float("TELEGRAM_CONNECT_TIMEOUT", 1.0)
TELEGRAM_READ_TIMEOUT = env_float("TELEGRAM_READ_TIMEOUT", 1.0)
VK_LONG_POLL_WAIT_SECONDS = env_int("VK_LONG_POLL_WAIT_SECONDS", 1)
VK_HTTP_TIMEOUT_SECONDS = env_float("VK_HTTP_TIMEOUT_SECONDS", 2.0)
