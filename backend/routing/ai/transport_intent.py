    ...
    def __init__(self):
        ...
        self.mode_keywords = {
            TransportMode.METRO: {
                ...
                "подземн", "метрополитен", "линия", "ветк",
            },
            TransportMode.BUS: {
                "автобус", "маршрутк", "пазик", "шаттл", "автобусн",
                "автобусы", "маршрутн", "рейсовый автобус",
            },
            TransportMode.TRAM: {
            ...
            TransportMode.TRAIN: {
                ...
                "поездн", "железнодорожн", "жд", "электричк",
                "пригородн", "дальн", "скорый",
            },
            TransportMode.AIRPLANE: {
                "самолет", "аэропорт", "борд", "рейс", "авиа",
                "авиационн", "самолетн", "авиакомпани",
            },
            TransportMode.WATER: {
                "паром", "теплоход", "судно", "лодк", "водн",
                "речн", "морск", "паромн",
            },
            TransportMode.TAXI: {
                "такси", "яндекс", "uber", "болт", "делимобил",
                "такс", "таксист", "таксопарк",
            },
        }
        self.positive_lexeme = {
            "спасибо", "классно", "отлично", "люблю", "замечательно",
            "прекрасно", "благодар", "доволен", "нравится", "хорошо",
            "супер", "молодцы", "рекомендую", "восхищен", "признателен",
        }
        self.negative_lexeme = {
            "ужас", "задержка", "наплевать", "негатив", "скандал",
            "плохо", "недоволен", "неприятно", "разочарован", "кошмар",
            "неудобно", "не работает", "опоздан", "слом", "проблем",
            "некачественно", "неприемлемо", "возмущен", "недовольств",
        }
